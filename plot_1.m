...
for i = 1:M
    ...
    d(i) = x_input(6) + 0.8 * x_input(7) + 0.3 * x_input(8) + 0.2 * x_input(6) * x_input(7) - 0.3 * x_input(6) * x_input(8) + 0.4 * x_input(6) * x_input(9) + 0.04 * x_input(6) * x_input(7) * x_input(8) - 0.02 * x_input(6) * x_input(7) * x_input(9);
end
...
for k = 1:T
    ...
    for i = 1:M
        ...
        W2(:,1) = W2(:,1) - miu2 * FEn * X2 * ys1(Beita+1)/(ys1(Beita+1)*ys1(Beita+1)*10 + yita);
        W2(:,2) = W2(:,2) - miu2 * FEn * X2 * ys2(Beita+1)/(ys2(Beita+1)*ys2(Beita+1)*10 + yita);
        
        W3(:,1) = W3(:,1) - miu3 * FEn * X2 * ys21(Beita+1)/(ys21(Beita+1)*ys21(Beita+1)*10 + yita2);
        W3(:,2) = W3(:,2) - miu3 * FEn * X2 * ys22(Beita+1)/(ys22(Beita+1)*ys22(Beita+1)*10 + yita2);
        W3(:,3) = W3(:,3) - miu3 * FEn * X2 * ys23(Beita+1)/(ys23(Beita+1)*ys23(Beita+1)*10 + yita2);
